...
public class RequestSubordinate {

    final String TYPE_UTF8_CHARSET = "charset=UTF-8";
    private  String  tokens;
    private  StringRequest stringRequest;
    private   FragmentActivity activity;
    public RequestSubordinate(StringRequest stringRequest, final FragmentActivity activity, final Handler hander) {
      this.stringRequest=stringRequest;
        ...
        stringRequest = new StringRequest(com.android.volley.Request.Method.GET,
                AppConst.Main+AppConst.SUORDINATE+"?token="+ tokens, new com.android.volley.Response.Listener<String>() {
            @Override
    ...
    public void saixuan(final Handler hander,String  sort,String name) {

        stringRequest = new StringRequest(com.android.volley.Request.Method.GET,
                AppConst.Main+AppConst.SUORDINATE+"?sort="+sort+"&name="+name+"&token="+ tokens, new com.android.volley.Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                String json = decodeUnicode.decodeUnicode(response);
                Message msg = new Message();
    ...
    //按名字筛选
    public void getnamesaixuan(final Handler hander) {
        stringRequest = new StringRequest(com.android.volley.Request.Method.GET,
                AppConst.Main+AppConst. SUORDINATEName+"?token="+ tokens, new com.android.volley.Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                String json = decodeUnicode.decodeUnicode(response);
                Message msg = new Message();
